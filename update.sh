...
$(git ls-remote --tags https://github.com/pematon/adminer.git \
...
for version in "${versions[@]}"; do
	...
	downloadSha256="$(
		curl -fsSL "https://github.com/pematon/adminer/releases/download/v${fullVersion}/adminer-${fullVersion}.php" \
			| sha256sum \
			| cut -d' ' -f1
	)"
